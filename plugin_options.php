...
class carousel_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('carousel', 'carousel', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="carousel"></div>';
  }
...
$carousel_options = new carousel_options();
$carousel_options->init();